---
name: qa-system
description: Full system test — codebase review against specs, full test suite, e2e flows, severity report. Invoke with /agn:qa-system before release.
---

# QA System (`/agn:qa-system`)
